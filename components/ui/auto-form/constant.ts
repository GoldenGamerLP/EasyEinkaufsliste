...
import AutoFormProfilePicture from './AutoFormProfilePicture.vue'
import LebensmittelArray from './AutoLebensmittelArray.vue'
...
export const INPUT_COMPONENTS: InputComponents = {
  ...
  profile: AutoFormProfilePicture,
  lebensmittelArray: LebensmittelArray,
